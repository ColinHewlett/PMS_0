...
import clinicpms.view.type.export_progress_view.ExportProgressView;
 ...
 * @author colin
 */
public class ExportProgressFactoryMethod extends ViewFactoryMethod{
    
    public ExportProgressFactoryMethod(ActionListener controller, EntityDescriptor ed, DesktopView dtView){
        initialiseView(controller, ed, dtView);
    }
    
    @Override
    public View makeView(View.Viewer myViewType){
        return new ExportProgressView(myViewType, this.getViewController(), 
