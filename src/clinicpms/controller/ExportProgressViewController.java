 ...
 * @author colin
 */
public class ExportProgressViewController extends ViewController{
    ...
    public ExportProgressViewController(DesktopViewController controller, DesktopView desktopView){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() instanceof DesktopViewController){
            ...
            EntityDescriptor.ExportProgressViewControllerActionEvent actionCommand =
               EntityDescriptor.ExportProgressViewControllerActionEvent.valueOf(e.getActionCommand());
            ...
            switch (actionCommand){
                ...
                case READY_FOR_RECEIPT_OF_PATIENT_PROGRESS:
                    actionEvent = new ActionEvent(
                        this,ActionEvent.ACTION_PERFORMED,
                        DesktopViewController.DesktopViewControllerActionEvent.EXPORT_MIGRATED_PATIENTS.toString());
                    getMyController().actionPerformed(actionEvent);
                    break;
                ...
                case READY_FOR_RECEIPT_OF_APPOINTMENT_PROGRESS:
                    actionEvent = new ActionEvent(
                        this,ActionEvent.ACTION_PERFORMED,
                        DesktopViewController.DesktopViewControllerActionEvent.EXPORT_MIGRATED_APPOINTMENTS.toString());
                    getMyController().actionPerformed(actionEvent);
                    break;

                case EXPORT_PROGRESS_CLOSE_NOTIFICATION:
                    actionEvent = new ActionEvent(
                        this,ActionEvent.ACTION_PERFORMED,
